--- Make sure `backlog` will work as expected.
---
...
local _LOGGER = logging_.get_logger("backlog.health")
...
---
---@param command string A supported `backlog` command. e.g. `"hello_world"`.
---@return string[] # All found issues, if any.
---
...
---
---@param data backlog.LoggingConfiguration The user's logger settings.
...
--- Make sure `data` will work for `backlog`.
---
---@param data backlog.Configuration? All extra customizations for this plugin.
---
function M.check(data)
    _LOGGER:debug("Running backlog health check.")
