...
local _LOGGER = logging.get_logger("backlog._commands.copy_logs.runner")

local M = {}

--- Modify the user's system clipboard with `result`.
---
---@param result backlog.ReadFileResult The file path + its contents that we read.
---
...
---@param callback fun(result: backlog.ReadFileResult): nil Call this once `path` is read.
---@private
---
