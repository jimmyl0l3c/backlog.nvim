--- The main parser for the `:Backlog hello-world` command.

local cmdparse = require("mega.cmdparse")
local constant = require("backlog._commands.hello_world.say.constant")
...
---@return mega.cmdparse.ParameterParser # The main parser for the `:Backlog hello-world` command.
function M.make_parser()
    ...
    phrase:set_execute(function(data)
        ...
        local runner = require("backlog._commands.hello_world.say.runner")
