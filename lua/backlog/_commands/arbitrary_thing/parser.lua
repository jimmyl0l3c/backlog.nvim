--- The main parser for the `:Backlog arbitrary-thing` command.

local cmdparse = require("mega.cmdparse")

local M = {}

---@return mega.cmdparse.ParameterParser # The main parser for the `:Backlog arbitrary-thing` command.
function M.make_parser()
    ...
    parser:set_execute(function(data)
        ...
        local runner = require("backlog._commands.arbitrary_thing.runner")
