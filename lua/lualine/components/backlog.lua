...
local copy_log_runner = require("backlog._commands.copy_logs.runner")
...
---@class backlog.LualineConfiguration
---    The Raw user settings from lualine's configuration.
---    e.g. `require("lualine").setup { sections = { { "backlog", ... }}}`
---    where "..." is the user's settings.
---@field display table<string, backlog.LualineDisplayData>?

---@class backlog.LualineDisplayData
---    Any text, icons, etc that will be displayed for `backlog` commands.
---@field prefix string
...
---
---@param options backlog.LualineConfiguration?
