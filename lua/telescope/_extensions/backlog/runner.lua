--- Register `backlog` to telescope.nvim.
---
...
vim.api.nvim_set_hl(0, "BacklogTelescopeEntry", { link = "TelescopeResultsNormal", default = true })
vim.api.nvim_set_hl(0, "BacklogTelescopeSecondary", { link = "TelescopeResultsComment", default = true })

---@alias telescope.CommandOptions table<any, any>

--- Run the `:Telescope backlog goodnight-moon` command.
---
            ...
            entry_maker = function(data)
                ...
                return {
                    display = function(entry)
                        return displayer({
                            { entry.name, "BacklogTelescopeEntry" },
                            { entry.author, "BacklogTelescopeSecondary" },
                        })
                    end,
                    author = author,
                    name = name,
...
--- Run the `:Telescope backlog hello-world` command.
---
---@param options telescope.CommandOptions The Telescope UI / layout options.
---
